...
├─ tests/source-tree.Tests.ps1 # 기존 회귀 + v2.4.6 receipt 불변식 격리 테스트
...
v2.4.6 검증은 Pester mock/fake Git/격리 OS process와 임시 사용자 홈 installed fixture만 사용한다. 유료 Grok·GPT·Claude live 호출은 실행하지 않았다. v2.4.4의 과거 격리 Grok live probe 1회는 이번 버전의 live 검증으로 승격하지 않는다.
