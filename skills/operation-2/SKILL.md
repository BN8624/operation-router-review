...
- `merge_ready`는 Draft가 ready-for-review로 바뀐 상태일 뿐 병합 완료가 아니다. CI pending/failed/unavailable, PR context 불일치, push 미완료 또는 unresolved router state에서는 merge_ready가 될 수 없으며 자동 merge는 없다.
